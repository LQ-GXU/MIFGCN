...
def read_and_generate_dataset(graph_signal_matrix_filename,
    ...
    all_samples = []
    for idx in range(data_seq.shape[0]):  # idx=2016 begin to get sample
        ...
        week_sample, day_sample, hour_sample, target = sample  # (12, 170, 3), (12, 170, 3) (12*3, 170, 3)
        # all_samples.append((
        ...
        all_samples.append((
            np.expand_dims(week_sample, axis=0)[:, :, :, 0:1],
            # (1, 170, 3, 12)
            np.expand_dims(day_sample, axis=0)[:, :, :, 0:1],
            np.expand_dims(hour_sample, axis=0)[:, :, :, 0:1],
    ...
    train_week, train_day, train_hour, train_target = training_set  # (9498, 170, 3, 12), same,(9498, 170, 3, 36) ,same
    val_week, val_day, val_hour, val_target = validation_set  # (3166, 170, 3, 12)
    test_week, test_day, test_hour, test_target = testing_set  # (3166, 170, 3, 12)
